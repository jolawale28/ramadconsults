    ...
    <>
      ...
      <section className="screenFrame lg:px-[50px] px-[12px] text-center flex flex-col gap-y-8 justify-center items-center py-14">
        ...
        <h1 className="md:text-[54px] text-[42px] leading-[100%] tracking-[-4%] lg:w-[871px] w-full">
          ...
          <span className="italic text-[#A93E41]">Excellence</span>
        </h1>
        <div className="md:w-[671px] w-full md:text-[18px] text-md leading-[25px] tracking-[-0.5px] text-[#404040]">
          Founded in 2020 by Forward-thinking engineers, RAMAD Consultants Ltd.
          is COREN-registered and headquartered in Abuja (with a Lagos branch),
          trusted by private developers and public-sector clients for
          innovative, professional structural, civil and MEP design solutions.
        </div>
      </section>
      ...
      <section className="screenFrame lg:px-[50px] px-[12px] lg:py-28 py-8">
          ...
          <div className="space-y-2 order-1">
            ...
            <div className="text-[25px] leading-[40px] tracking-[-3%]">
              <span className="text-[#A93E41] italic font-light">
                To be a leading choice for engineering design services
              </span>{" "}
              your one-stop destination for structural, civil, and MEP
              engineering needs.
            </div>
            ...
            <div className="text-[25px] leading-[40px] tracking-[-3%]">
              <span className="text-[#A93E41] italic font-light">
                ...
                engineering design solutions that meet international safety and
                quality standards
              </span>{" "}
              by leveraging cutting-edge technology, continuous professional
              development, and an unwavering commitment to credibility,
              integrity, and client trust in every project.
            </div>
          </div>
        </div>
        ...
        <div className="mt-20">
          <div className="flex justify-center">
            <div className="w-fit border border-[#A93E41] text-xs font-semibold px-4 py-1.5 rounded-full text-[#A93E41]">
              Our Numbers
            </div>
          </div>
      ...
      <section className="bg-[#FBFAF8] screenFrame lg:px-[50px] px-[12px] lg:py-28 py-8">
        ...
        <div className="text-center text-[#404040]/70 leading-[25px] text-[18px] font-[350] w-full md:w-[498px] mx-auto">
          These values guide every decision we make, ensuring every project
          succeeds with integrity and excellence.
        </div>
        <div className="grid grid-cols-[repeat(auto-fit,_350px)] gap-5 justify-center justify-items-center mt-16">
          {coreValues.map((ele) => (
            <div
              key={`sersgfh_${ele.title.replaceAll(" ", "")}`}
              className="border border-gray-200 p-5 rounded-md space-y-2"
            >
              <div>{ele.icon}</div>
